...
namespace NormalFactory
{
    ...
    public class Tiger : IAnimal
    {
        ...
        public class TigerFactory : IAnimalFactory
        {
            ...
            {
                public static IAnimalFactory Get(categories category)
                {

                    if (category == categories.dog)
                    {
                        return new DogFactory();
                    }
                    else if (category == categories.tiger)
                    {
    ...
    class Client
        {
            ...
            //---------------------------------------------------------------------------//
                 ...
                 IAnimalFactory f = FactoryMethod.Get(categories.dog);
            }
    }
